...
// classifyRoomType moved to lib/rooms/room-type.ts — the color form needs
// the same answer and cannot import this module. Re-exported so every caller
// here is unchanged.
import { classifyRoomType } from "@/lib/rooms/room-type";
export { classifyRoomType };
