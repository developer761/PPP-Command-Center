    ...
    >
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.footer} fixed>
          {/* Names the operating company and the document, like every other
              GC-facing PDF. It used to end "Generated by Commercial Command
              Center" — our internal tool, and PPP's name, on the bottom of a
              TOMCO document going to the architect. */}
          <Text style={styles.footerText}>
            {fromCompany} · Letter of Transmittal
          </Text>
