...
const NAV = [
  ...
  { href: "/messaging/review", label: "To approve", icon: "M9 11l3 3L22 4 M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" },
  ...
  { href: "/messaging/rules", label: "Rules", icon: "M9 11H3v10h6z M15 3H9v18h6z M21 7h-6v14h6z" },
