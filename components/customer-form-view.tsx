  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
      ...
      <div className="bg-white border border-ppp-charcoal-100 rounded-2xl p-5 sm:p-7">
        ...
        {isPreview && (
          <div className="mt-4 text-xs sm:text-sm text-ppp-orange-700 bg-ppp-orange-50 border border-ppp-orange-100 rounded-lg px-3 py-2 leading-relaxed">
          ...
          <div className="flex flex-col gap-1">
            <select
              ...
              className={[
                ...
                finishMissing
                  ? "border-ppp-orange-100 focus:ring-ppp-orange-100 focus:border-ppp-orange-500"
