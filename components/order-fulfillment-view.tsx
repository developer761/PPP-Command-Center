    ...
    return (
      <div className="max-w-lg mx-auto text-center py-12">
        ...
        <Link
          ...
          className="mt-6 inline-flex items-center gap-1.5 px-4 py-2 min-h-[44px] rounded-lg bg-ppp-blue text-ppp-navy text-sm font-semibold hover:bg-ppp-blue-300 transition-colors"
        >
          Back to work order
        </Link>
      </div>
          ...
          {draft?.phoneOnly ? (
            <div className="flex flex-col items-end gap-1">
              {draft.phoneNumber ? (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 min-h-[44px] rounded-lg bg-ppp-blue text-ppp-navy text-sm font-semibold hover:bg-ppp-blue-300 transition-colors"
                >
            ...
            return (
              <button
                ...
                className="px-4 py-2 min-h-[44px] max-w-full inline-flex items-center justify-center rounded-lg bg-ppp-blue text-ppp-navy text-sm font-semibold hover:bg-ppp-blue-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
