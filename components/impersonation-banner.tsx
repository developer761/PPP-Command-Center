  ...
  return (
    <div className="bg-ppp-orange-700 text-ppp-orange-50 px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between gap-3 text-[12px] sm:text-[13px]">
      ...
      <button
        ...
        onClick={exit}
        disabled={isPending}
        className="shrink-0 inline-flex items-center gap-1 px-3 py-2 sm:py-1 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white font-medium transition-colors disabled:opacity-60 min-h-[44px] sm:min-h-0 touch-manipulation"
      >
