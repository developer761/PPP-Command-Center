    ...
    <>
      <div className="flex flex-wrap items-stretch gap-2">
        <button
          ...
          className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 min-h-[44px] sm:min-h-0 rounded-lg bg-ppp-blue text-ppp-navy text-sm font-medium hover:bg-ppp-blue-300 transition-colors shadow-sm shadow-ppp-blue/30 flex-1 sm:flex-none"
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
            ...
            <div className="px-5 sm:px-6 py-3.5 border-t border-ppp-charcoal-100 bg-white shrink-0 flex items-center justify-end gap-2">
              ...
              {result?.ok === false && !result.formUrl && (
                <button
                  ...
                  className="px-3.5 py-2 min-h-[44px] sm:min-h-0 rounded-lg bg-ppp-blue text-ppp-navy text-sm font-semibold hover:bg-ppp-blue-300 transition-colors inline-flex items-center gap-1.5"
                >
                  Try again
                </button>
              )}
              {!result && (
                <button
                  ...
                  className="px-3.5 py-2 min-h-[44px] sm:min-h-0 rounded-lg bg-ppp-blue text-ppp-navy text-sm font-semibold hover:bg-ppp-blue-300 transition-colors disabled:opacity-60 disabled:cursor-not-allowed inline-flex items-center gap-1.5"
                >
                  {sending && (
