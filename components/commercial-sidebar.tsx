...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      // In the nav rather than buried in Settings: the people who need it most
      // are the ones who do not yet know Settings exists.
      { label: "How it works", href: "/commercial/guide", icon: <IconBook /> },
    ],
  },
