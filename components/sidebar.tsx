                ...
                return (
                  <li key={item.href}>
                    ...
                    >
                      ...
                      {badgeCount > 0 && (
                        <span
                          className="shrink-0 inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-full text-[10px] font-bold bg-ppp-orange-700 text-ppp-orange-50"
