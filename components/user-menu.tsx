  ...
  return (
    <div className="relative" ref={rootRef}>
      <button
        ...
        aria-expanded={open}
        className={[
          "h-11 w-11 sm:h-9 sm:w-9 rounded-full bg-ppp-blue text-ppp-navy flex items-center justify-center font-semibold text-sm shadow-sm shadow-ppp-blue/30",
      ...
      {open && (
        ...
        >
          ...
          <Link
            ...
            className="w-full text-left px-4 py-2.5 text-sm font-medium text-ppp-charcoal hover:bg-ppp-charcoal-50 transition-colors flex items-center gap-2"
          >
          ...
          <button
            ...
            onClick={signOut}
            disabled={signingOut}
            className="w-full text-left px-4 py-2.5 text-sm font-medium text-ppp-charcoal hover:bg-ppp-charcoal-50 disabled:opacity-60 transition-colors flex items-center gap-2 min-h-[44px] sm:min-h-0 touch-manipulation"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
