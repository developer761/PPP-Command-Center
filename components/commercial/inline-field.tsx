      ...
      <span className="flex items-start gap-1.5 min-w-0">
        ...
        {canEdit && (
          <Link
            ...
            className="shrink-0 inline-flex items-center justify-center h-6 w-6 rounded-md text-ppp-charcoal-400 hover:text-cc-brand-700 hover:bg-cc-brand-50 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:focus:opacity-100 transition-opacity"
          >
