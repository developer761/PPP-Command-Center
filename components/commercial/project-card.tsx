      ...
      <div className="pl-5 pr-4 py-3.5">
        <div className="flex items-center justify-between gap-2 mb-1">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            {p.isClosedOut && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full border border-ppp-navy-200 bg-ppp-navy-50 text-[9.5px] font-bold uppercase tracking-wide text-ppp-navy-700" title="Closeout package complete">
