...
export async function GET(_req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    pdf = await renderWarrantyLetterPdf({ pkg, dealName, company: { name: oc.name, phone: oc.phone, website: oc.website }, logo: await getBrandLogoBuffer(), signature: await getBrandSignatureBuffer() });
  } catch (err) {
