...
export async function GET(_req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  const { data: oppRow } = await sb
    ...
    .select("title, title_override, title_override_mode, client_name, property_street, property_city, property_state, project_number, account_id, status, sub_status, deleted_at")
