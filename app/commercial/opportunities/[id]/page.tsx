...
function KpiTile({
  ...
  return (
    <div className="relative border border-ppp-charcoal-100 rounded-lg px-3 pt-3.5 pb-3 bg-gradient-to-br from-white to-ppp-blue-50/40 min-h-[64px] flex flex-col justify-center shadow-sm overflow-hidden">
      <span className="absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r from-ppp-blue-500 to-cyan-400" aria-hidden />
