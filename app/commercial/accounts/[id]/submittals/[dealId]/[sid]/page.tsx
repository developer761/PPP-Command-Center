...
async function bulkLinkAttachmentsAction(formData: FormData) {
  ...
  const errBase = `/commercial/accounts/${account_id}/submittals/${opportunity_id}/${submittal_id}` +
...
export default async function SubmittalDetailPage({
  ...
  return (
    <div className="space-y-5 max-w-4xl">
      ...
      {/* Header (2026-07-29: removed the duplicate back-link that sat here —
          the one above the banners is enough; two stacked back-links to the
          same URL just added vertical clutter). */}
      <header className="bg-surface border border-ppp-charcoal-100 rounded-xl p-4 sm:p-5">
        ...
        {submittal.revises_submittal_id && (
          <div className="mt-4 px-3 py-2.5 rounded-lg bg-ppp-blue-50 border border-ppp-blue-100 text-[12px] text-ppp-blue-900 flex items-start gap-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <Link
                href={`/commercial/accounts/${account_id}/submittals/${opportunity_id}/${submittal.revises_submittal_id}`}
