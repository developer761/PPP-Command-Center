  ...
  return (
    <li className="relative bg-surface border border-ppp-charcoal-100 rounded-xl overflow-hidden hover:border-cc-brand-200 hover:shadow-md transition-all">
      ...
      <div className="flex items-stretch border-t border-ppp-charcoal-100 divide-x divide-ppp-charcoal-100 text-[12px] font-semibold">
        ...
        <Link href={closeoutHref} className="flex-1 inline-flex items-center justify-center gap-1.5 min-h-[44px] text-ppp-charcoal-700 hover:bg-cc-brand-50 hover:text-cc-brand-800 touch-manipulation">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden><path d="M9 11l3 3L22 4 M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" /></svg>
          Closeout
        </Link>
      </div>
    </li>
