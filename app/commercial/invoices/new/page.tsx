  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 space-y-4">
      ...
      <div className="flex items-start gap-2">
        <Link
          href={backHref}
          aria-label={cameFromDeal ? "Back to the opportunity" : fromRaw ? "Back" : "Back to all invoices"}
          className="inline-flex items-center justify-center w-11 h-11 sm:w-9 sm:h-9 rounded-md text-ppp-charcoal-500 hover:text-ppp-charcoal hover:bg-ppp-charcoal-100 touch-manipulation shrink-0 mt-1"
        >
