  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col gap-2 p-5 rounded-xl bg-ppp-charcoal-50/40 border border-dashed border-ppp-charcoal-200">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[15px] font-bold text-ppp-charcoal-500">Week Grid · Jobs · Clock · Payroll</span>
          </div>
          <p className="text-[13px] text-ppp-charcoal-500 leading-relaxed">Building next — the scheduling grid, jobs, clock in/out, and payroll export land here as we roll them out.</p>
        </div>
      </div>
    </div>
  );
