    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-8 space-y-4">
      ...
      {t.dealCount === 0 ? (
        <div className="text-center py-14 px-4 bg-surface border border-ppp-charcoal-100 rounded-xl">
          ...
          <p className="text-[12px] text-ppp-charcoal-500 mt-1 max-w-sm mx-auto">Once a deal has a contract, billing, or a logged cost, it shows up here with its margin. Log costs on any deal&rsquo;s Costs &amp; P&amp;L tab.</p>
