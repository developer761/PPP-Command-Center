...
export default function ArchivedLoading() {
  return (
    <div className="space-y-4 animate-pulse" aria-hidden>
      <div className="h-6 w-52 bg-white border border-ppp-charcoal-100 rounded" />
      <div className="h-4 w-80 max-w-full bg-white border border-ppp-charcoal-100 rounded" />
