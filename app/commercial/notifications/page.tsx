    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="flex items-start justify-between gap-3">
        ...
        <Link
          ...
          className="shrink-0 inline-flex items-center gap-1.5 rounded-lg border border-ppp-charcoal-200 bg-surface px-3 py-2 text-xs font-semibold text-ppp-charcoal-600 hover:bg-ppp-charcoal-50 min-h-[44px] touch-manipulation"
        >
