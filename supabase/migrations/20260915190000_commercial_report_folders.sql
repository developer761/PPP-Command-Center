  ...
  for f in
    select * from (values
      ('6f1d3c2a-5b7e-4c1a-9d0e-000000000001'::uuid, 'Manager', 'Every report — the whole company at a glance.', 'briefcase', 10,
        array['pipeline','geography','estimator','signatures','win-loss','jobs','job-costs','labor','change-orders','cash-flow','receivables','ar-aging','scheduling','open-sales','attendance'],
